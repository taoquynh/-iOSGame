...
// SVProgressHUD  dùng để xoay xoay load
// hiện thì gọi SVProgressHUD.show()
// tắt thì gọi SVProgressHUD.dismiss()
// goij o dau duoc nhi
// khi bắt đầu gọi api thì show lên
// khi gọi xong api, parse dữ liệu xong thì dismiss đi
// nếu lỗi cũng phải dismiss đi, k là nó k tắt đâu
// gio em se lam khi xem lich su thi timeLabel la thoi gian minh nop
 // the thi model phai co them 1 truong timeFinish,
// mat cong nhi
// nen tao database phải làm từ đâu, phân tích hết trường hợp
